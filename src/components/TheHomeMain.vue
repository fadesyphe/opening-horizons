<template>
  <div class="w-full max-w-[1100px] px-3 py-9 mx-auto bg-green text-white">
    <div>
      ...
      <p class="mt-4 mb-3 leading-3 text-center text-[11px] relative">
      ...
      <img class="my-9 w-full" src="../assets/images/home-main.jpg" alt="" />
      <div class="w-full flex justify-center">
        <BaseButton class="flex mx-auto text-center">Свяжитесь с нами</BaseButton>
      </div>
    </div>
  </div>
</template>
